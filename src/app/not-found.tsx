    ...
    <div className="flex h-screen w-full bg-bg-main">
      ...
      <div className="w-full">
        ...
        <div>
          ...
          <p className="font-Ambit font-normal text-sm text-center mt-5">
            Page not found
          </p>
          <p className="font-Ambit font-normal text-sm text-center mt-5 text-regal-grey px-6">
          ...
          <div className="flex justify-center">
            <Link
              href="/"
              className="flex bg-regal-blue text-white w-48 h-11 items-center justify-center rounded-lg"
            >
              <MoveLeft />
